...
def fit_symantic(df: pd.DataFrame, smiles_col: str = "SMILES", target_col: str = "logS", downsample_size: int = None, top_n_features: int | None = 20, known_equation: str | None = None):
